//
//  YuXuanSaiViewController.m
//  TestTest
//
//  Created by 程海峰 on 2017/3/6.
//  Copyright © 2017年 海峰. All rights reserved.
//

#import "YuXuanSaiViewController.h"
#import "CountryCupModeCalcul.h"

@interface YuXuanSaiViewController ()
...
@property (strong, nonatomic) NSMutableArray *allArray,*yazuliancansaiArray,*ouzuliancansaiArray,*nanmeizuliancansaiArray,*beimeizuliancansaiArray,*feizuliancansaiArray;
@property (assign, nonatomic) NSInteger jilu;
@end

@implementation YuXuanSaiViewController
...
-(NSMutableArray *) shaixuanshujuwithArray:(NSMutableArray *) arra andkeyStr:(NSString *) keyStr{
    ...
    for (NSDictionary *dic in arra) {
        if ((keyStr != nil) && (![keyStr isEqualToString:@""])) {
            if ([[dic valueForKey:@"prov"] isEqualToString:keyStr]) {
...
- (void)viewDidLoad {
    ...
    self.yazuliancansaiArray = [NSMutableArray arrayWithArray:[self shaixuanshujuwithArray:arra andkeyStr:@"亚足联"]];
    self.ouzuliancansaiArray = [NSMutableArray arrayWithArray:[self shaixuanshujuwithArray:arra andkeyStr:@"欧足联"]];
    self.nanmeizuliancansaiArray = [NSMutableArray arrayWithArray:[self shaixuanshujuwithArray:arra andkeyStr:@"南美足联"]];
    self.beimeizuliancansaiArray = [NSMutableArray arrayWithArray:[self shaixuanshujuwithArray:arra andkeyStr:@"中北美足联"]];
    self.feizuliancansaiArray = [NSMutableArray arrayWithArray:[self shaixuanshujuwithArray:arra andkeyStr:@"非足联"]];
